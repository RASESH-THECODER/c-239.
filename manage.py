from flask.cli import FlaskGroup    #importing of library files
...
cli = FlaskGroup(create_app=create_app)  #class FlaskGroup

user_json = [
	{											#conataing name,email,password,contact of the custommer
		"name": "John Doe",
...
product_json = [
	{										#containing name,image,rating,marked_price,selling price of the product
...
def rsd():
	...
	recreate_db()
	seeder()
				#import code to excute the file			
